##############################################################
#
# This script takes P and Q from a "synthetic" measurement day: missing and NaN values are replaced/allocated 
...
for row_idx in 1:size(p_gen)[1]
    assign_powerflow_input!(ntw, row_idx, p_load, q_load, p_gen, q_gen, volts)
